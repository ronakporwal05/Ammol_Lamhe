...
import { getEvent, getEventPhotos, incrementClientCount } from '@/firebase/firestore'
import { loadModels } from '@/faceRecognition/loadModels'
import { matchFaces } from '@/faceRecognition/matchFaces'
    ...
    try {
      ...
      if (matchedPhotos.length > 0) {
        try {
          ...
          console.warn('Failed to increment client count:', err)
        }
      }
    } catch (err) {
